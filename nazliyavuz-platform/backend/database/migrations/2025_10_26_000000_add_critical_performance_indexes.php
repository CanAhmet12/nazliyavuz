...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('teachers', function (Blueprint $table) {
            ...
            if (!$this->indexExists('teachers', 'teachers_online_available_rating_index')) {
                $table->index(['online_available', 'rating_avg'], 'teachers_online_available_rating_index');
            }
            
            // Index for approved teachers with rating
            if (!$this->indexExists('teachers', 'teachers_is_approved_rating_index')) {
                $table->index(['is_approved', 'rating_avg'], 'teachers_is_approved_rating_index');
            }
            
            // Index for price range queries
            if (!$this->indexExists('teachers', 'teachers_price_hour_index')) {
                $table->index(['price_hour'], 'teachers_price_hour_index');
            }
        });
    ...
    public function down(): void
    {
        ...
        Schema::table('teachers', function (Blueprint $table) {
            ...
            $table->dropIndex('teachers_price_hour_index');
        });
